        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="space-y-4">
              ...
              <p className="text-blue-200">+7 (978) 123-45-67</p>
              <p className="text-blue-200">+7 (365) 234-56-78</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-blue-200">info@crimtrans.ru</p>
              <p className="text-blue-200">booking@crimtrans.ru</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-blue-200">г. Симферополь</p>
              <p className="text-blue-200">ул. Транспортная, 15</p>
            </div>
          </div>
